...
def meanmedian(x, n, axis=-1):
    ...
    The goal is to have a simple "more continuous" estimate of the median of a
    waveform.
    ...
    axis : int
        The axis along which the operation is applied, default last. If the
        axis size is not a multiple of n, the last indices are ignored.
